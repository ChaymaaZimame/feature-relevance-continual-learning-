...
from methods.importance_scaler_effective_lr_mean_factor_beta import ImportanceScaler
...
if __name__ == "__main__":
    ...
    neuron_imp_calc = NeuronImportanceCalculator(delta=cfg.IMPORTANCE.DELTA)
    # param grads scaling using importance
    importance_scaler = ImportanceScaler(eps=1e-6, writer=writer)    
